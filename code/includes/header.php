...
echo 'Looks like Open Vend Manage is NOT already installed!</br>';
echo 'Please go to <a href="install/installer.php">the installer.</a>';
echo '<br><br>';
